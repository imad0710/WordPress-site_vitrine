        ...
        <div class="container">
            <nav class="flex items-center justify-between">
                ...
                <div class="left flex items-center justify-between">
                    ...
                    <div class="branding">
                        <img src="http://localhost/wordpress/wp-content/themes/sitevitrine/http://localhost/wordpress/wp-content/themes/sitevitrine/image/512px-VR_Logo_Virtual_Reality_Logo.svg-removebg-preview - Copie.png" style="width:70px ;">
                    </div>
            ...
            <div class="hero flex ">
                ...
                <div class="left">
                    <img src="http://localhost/wordpress/wp-content/themes/sitevitrine/http://localhost/wordpress/wp-content/themes/sitevitrine/image/girl.png">
                </div>
        ...
        <ul id="autoWidth" class="cs-hidden">
            ...
            <li class="item-a">
                ...
                <div class="box">
                    <!--img-box---------->
                    <div class="slide-img">
                        <img alt="1" src="http://localhost/wordpress/wp-content/themes/sitevitrine/http://localhost/wordpress/wp-content/themes/sitevitrine/image/téléchargement.jpg">
                        <!--overlayer---------->
                        <div class="overlay">
                            <!--buy-btn------>
            ...
            <li class="item-b">
                ...
                <div class="box">
                    <!--img-box---------->
                    <div class="slide-img">
                        <img alt="2" src="http://localhost/wordpress/wp-content/themes/sitevitrine/image/téléchargement (1).webp">
                        <!--overlayer---------->
                        <div class="overlay">
                            <!--buy-btn------>
                            <a href="#" class="buy-btn">Buy Now</a>
            ...
            <li class="item-c">
                ...
                <div class="box">
                    <!--img-box---------->
                    <div class="slide-img">
                        <img alt="3" src="http://localhost/wordpress/wp-content/themes/sitevitrine/image/Capture d’écran (64).png">
                        <!--overlayer---------->
                        <div class="overlay">
                            <!--buy-btn------>
                            <a href="#" class="buy-btn">Buy Now</a>
            ...
            <li class="item-e">
                ...
                <div class="box">
                    <!--img-box---------->
                    <div class="slide-img">
                        <img alt="5" src="http://localhost/wordpress/wp-content/themes/sitevitrine/image/Capture d’écran (65).png">
                        <!--overlayer---------->
                        <div class="overlay">
                            <!--buy-btn------>
                            <a href="#" class="buy-btn">Buy Now</a>
    ...
    <section class="Accssoir section bd-container flex justify-between items-center " id="Accessoir">
        ...
        <div class="Accssoir__container  bd-grid">
            ...
            <div style="margin-left: 160px;" class="Accssoir__content2">
                <img class="accesoir-img" src="http://localhost/wordpress/wp-content/themes/sitevitrine/image/téléchargement (5).webp">
            ...
            <div style="margin-left: 100px;" class="Accssoir__content2">
                <img class="accesoir-img" src="http://localhost/wordpress/wp-content/themes/sitevitrine/image/téléchargement (6).webp">
            ...
            <div style="margin-left: 100px;" class="Accssoir__content2" style="	box-shadow: 2px 2px 30px rgba(0,0,0,0.2);">
                <img class="accesoir-img" src="http://localhost/wordpress/wp-content/themes/sitevitrine/image/téléchargement (7).webp">
            ...
            <div style="margin-left: 160px;" class="Accssoir__content2" style="	box-shadow: 2px 2px 30px rgba(0,0,0,0.2);">
                <img class="accesoir-img" src="http://localhost/wordpress/wp-content/themes/sitevitrine/image/téléchargement (8).webp">
            ...
            <div style="margin-left: 100px;" class="Accssoir__content2" style="	box-shadow: 2px 2px 30px rgba(0,0,0,0.2);">
                <img class="accesoir-img" src="http://localhost/wordpress/wp-content/themes/sitevitrine/image/téléchargement (9).webp">
            ...
            <div style="margin-left: 100px;" class="Accssoir__content2" style="	box-shadow: 2px 2px 30px rgba(0,0,0,0.2);">
                <img class="accesoir-img" src="http://localhost/wordpress/wp-content/themes/sitevitrine/image/téléchargement (10).webp">
            ...
            <div style="margin-left: 160px;" class="Accssoir__content2" style="	box-shadow: 2px 2px 30px rgba(0,0,0,0.2);">
                <img class="accesoir-img" src="http://localhost/wordpress/wp-content/themes/sitevitrine/image/téléchargement (11).webp">
            ...
            <div style="margin-left: 100px;" class="Accssoir__content2" style="	box-shadow: 2px 2px 30px rgba(0,0,0,0.2);">
                <img class="accesoir-img" src="http://localhost/wordpress/wp-content/themes/sitevitrine/image/téléchargement (12).webp">
